...
printf " \n"
printf " \n"
printf ' \e[0m[\e[0m\e[0m~\e[0m\e[0m]\e[0m\e[0m N copia y pega esto en una nueva terminal: \e[0m\e[0m %s \n' 
printf " \n"
printf " \n"
printf ' \e[1;31m ssh -R 80:localhost:'$port' serveo.net \e[1;31m\e[1;31m %s \n'
printf " \n"
printf " \n"
printf ' \e[0m[\e[0m\e[0m~\e[0m\e[0m]\e[0m\e[0m Para un subdominio personalizado cambia la palabra "indigo" por el subdominio que quieras: \e[0m\e[0m %s \n'
printf " \n"
printf " \n"
printf ' \e[1;31m ssh -R indigo:80:localhost:'$port' serveo.net \e[1;31m\e[1;31m %s \n'
printf " \n"
printf " \n"
printf " \n"
found
